...
# saving files ----
save(preprocessed_covid_multi_imputed, file = "data/preprocessed/multivariate/preprocessed_covid_multi_imputed.rda")
save(brazil, file = "data/preprocessed/univariate/brazil.rda")
save(turkey, file = "data/preprocessed/univariate/turkey.rda")
save(russia, file = "data/preprocessed/univariate/russia.rda")
save(us, file = "data/preprocessed/univariate/us.rda")
save(iran, file = "data/preprocessed/univariate/iran.rda")
save(saudi, file = "data/preprocessed/univariate/saudi.rda")
save(colombia, file = "data/preprocessed/univariate/colombia.rda")
save(mexico, file = "data/preprocessed/univariate/mexico.rda")
save(bolivia, file = "data/preprocessed/univariate/bolivia.rda")
save(peru, file = "data/preprocessed/univariate/peru.rda")

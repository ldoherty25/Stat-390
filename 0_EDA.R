...
save(brazil, file = "data/preprocessed/univariate/not_split/brazil.rda")
save(turkey, file = "data/preprocessed/univariate/not_split/turkey.rda")
save(russia, file = "data/preprocessed/univariate/not_split/russia.rda")
save(us, file = "data/preprocessed/univariate/not_split/us.rda")
save(iran, file = "data/preprocessed/univariate/not_split/iran.rda")
save(saudi, file = "data/preprocessed/univariate/not_split/saudi.rda")
save(colombia, file = "data/preprocessed/univariate/not_split/colombia.rda")
save(mexico, file = "data/preprocessed/univariate/not_split/mexico.rda")
